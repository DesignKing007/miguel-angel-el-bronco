...
function tooltip(tiptitle,tipbold,tipnormal){
    ...
    ///jdr added for toggle help tips on/off
    if (document.getElementById('helptips')) {
       if (!document.getElementById('helptips').checked && tiptitle != 'Register PowerEffects For Free!') return false;
    }
